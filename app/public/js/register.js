...
BASE_URL_1["default"]();
var template = __webpack_require__(480);
var datas = {
    username: 'admin',
    password: 'admin',
    captcha: ''
...
var regist = (function (_super) {
    ...
    regist.prototype.beforeRender = function () {
    };
    regist.prototype.afterRender = function () {
        var _this = this;
    ...
    regist.prototype.warning = function (ss) {
        var war = document.getElementById("warning");
        war.style.color = '#e2644c';
        document.getElementById("warText").innerText = ss;
    };
    regist.prototype.onRegists = function () {
        var _this = this;
        datas.username = document.getElementById("email").value;
    ...
    regist.prototype.onLoginBtn = function () {
        //console.info('组件1test_event事件参数：', args);
        window.location.href = 'login.html';
    };
    regist.prototype.onImgClick = function () {
        document.getElementById('imgPass').src = config_1.get().BASE_URL + "appdist/imgVerification?" + Date.now();
        datas.captcha = '';
    };
    return regist;
...
var register1_1 = __webpack_require__(269);
new register1_1["default"]('#register');
